...
from report_app.report_contractor.views import ContractorReporSentView, ContractorReporReceivedView, ContractorReportReturnView, ContractorReportsView, ContractorReportView
